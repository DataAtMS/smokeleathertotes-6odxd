...
export default function Disclaimer() {
  ...
  useEffect(() => {
    document.title = 'Affiliate Disclaimer | Smoke Leather Totes';
    ...
    setMeta('meta[name="description"]', 'description', 'Affiliate and earnings disclaimer for Smoke Leather Totes.', 'name');
    setMeta('meta[property="og:title"]', 'og:title', 'Affiliate Disclaimer | Smoke Leather Totes', 'property');
      ...
      <main style={{ maxWidth: "720px", margin: "0 auto", padding: "clamp(40px, 8vw, 72px) clamp(24px, 6vw, 48px)" }}>
        ...
        <div style={{ background: "#0d0d0d", border: `1px solid ${COLOR.accent}33`, borderLeft: `3px solid ${COLOR.accent}`, borderRadius: "4px", padding: "20px 24px", marginBottom: "40px" }}>
          <p style={{ fontFamily: "Georgia, serif", fontSize: "15px", color: "#c8c8c8", lineHeight: 1.7, margin: 0 }}>
            <strong style={{ color: "#f0f0f0" }}>Disclosure:</strong> Some links on Smoke Leather Totes are affiliate links. If you click one and make a purchase, we may earn a commission at no extra cost to you. We only recommend tools we have personally tested.
          </p>
        </div>
