...
const CATEGORY_SEO: Record<string, { metaTitle: string; metaDescription: string; h1: string; intro: string }> = {
  "reviews": { metaTitle: 'Reviews | Smoke Leather Totes', metaDescription: 'Browse 3 articles about reviews on Smoke Leather Totes.', h1: 'Reviews', intro: 'Browse 3 articles about reviews on Smoke Leather Totes.' },
  "comparisons": { metaTitle: 'Comparisons | Smoke Leather Totes', metaDescription: 'Browse 0 articles about comparisons on Smoke Leather Totes.', h1: 'Comparisons', intro: 'Browse 0 articles about comparisons on Smoke Leather Totes.' },
  "guides": { metaTitle: 'Guides | Smoke Leather Totes', metaDescription: 'Browse 0 articles about guides on Smoke Leather Totes.', h1: 'Guides', intro: 'Browse 0 articles about guides on Smoke Leather Totes.' }
};
...
export default function CategoryPage() {
  ...
  useEffect(() => {
    ...
    const pageUrl = 'https://smokeleathertotes-6odxd.com/' + slug;
    ...
    script.textContent = JSON.stringify({
      ...
      "breadcrumb": {
        "@type": "BreadcrumbList",
        "itemListElement": [
          { "@type": "ListItem", "position": 1, "name": "Home", "item": 'https://smokeleathertotes-6odxd.com' },
