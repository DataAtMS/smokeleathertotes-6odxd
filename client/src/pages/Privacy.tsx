...
export default function Privacy() {
  ...
  useEffect(() => {
    document.title = 'Privacy Policy | Smoke Leather Totes';
    ...
    setMeta('meta[name="description"]', 'description', 'Privacy Policy for Smoke Leather Totes. How we collect, use, and protect your information.', 'name');
    setMeta('meta[property="og:title"]', 'og:title', 'Privacy Policy | Smoke Leather Totes', 'property');
