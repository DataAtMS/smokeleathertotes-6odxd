...
export default function ArticlePage() {
  ...
  useEffect(() => {
    ...
    document.title = article.title + ' | Smoke Leather Totes';
    ...
    const pageUrl = 'https://smokeleathertotes-6odxd.com/articles/' + article.slug;
    const catUrl = 'https://smokeleathertotes-6odxd.com/' + article.categorySlug;
    ...
    articleScript.textContent = JSON.stringify({
      ...
      "author": { "@type": "Organization", "name": 'Smoke Leather Totes' },
      "publisher": { "@type": "Organization", "name": 'Smoke Leather Totes', "url": 'https://smokeleathertotes-6odxd.com' },
      "url": pageUrl,
    });
    ...
    return (
      <div style={{ minHeight: "100vh", background: "#0a0a0a", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center" }}>
          ...
          <Link href="/"><span style={{ color: "#ff0066", fontFamily: "monospace", fontSize: "12px", cursor: "pointer" }}>← BACK TO HOME</span></Link>
        </div>
      </div>
    );
  }
